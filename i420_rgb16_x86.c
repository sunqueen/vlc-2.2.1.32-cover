...
VLC_TARGET
static void I420_A8R8G8B8( filter_t *p_filter, picture_t *p_src,			// sunqueen modify
                                            picture_t *p_dest )
{
    /* We got this one from the old arguments */
...
VLC_TARGET
static void I420_B8G8R8A8( filter_t *p_filter, picture_t *p_src, picture_t *p_dest )			// sunqueen modify
{
    /* We got this one from the old arguments */
    uint32_t *p_pic = (uint32_t*)p_dest->p->p_pixels;
    uint8_t  *p_y   = p_src->Y_PIXELS;
